...
IC - Indescribable Community


IC 是一个类似区块链社区的 UDP 数据包转发集群，集群将来自应用程序的数据包通过最优路径转发到目标服务器。


社区节点类型：

    客户端节点：运行于客户机上的 ic 节点。社区的数据来源，将客户机上的所有数据转发入社区。
...
功能分层：
    ...
    协议层：对即将要发出的数据进行封装，使其成为一个合法的 IC 数据包
